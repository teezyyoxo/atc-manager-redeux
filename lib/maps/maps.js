import newYorkMaps from './new-york';
import additionalUsAirports from './additional-us-airports';
...
const maps = {
  'default': {
    ...
    'airport': {
      'blacklist': [],
      'operatorWhitelist': [0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 18, 19, 20, 22, 23, 25, 26, 27, 28, 29, 30, 33, 34],
      'region': 'global',
      'elevation': 22,
      'rwyusage': [
        {
  ...
  'heathrow': {
    ...
    'airport': {
      'elevation': 77,
      'blacklist': [],
      'operatorWhitelist': [0, 1, 2, 3, 5, 6, 8, 9, 10, 11, 12, 14, 15, 18, 19, 20, 22, 23, 26, 27, 28, 29, 30, 33],
      'region': 'europe',
      'rwyusage': [
        {
          'dir': 1,
  ...
  'klax': {
    ...
    'airport': {
      'blacklist': [],
      'operatorWhitelist': [0, 1, 3, 4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 18, 19, 20, 22, 23, 26, 27, 29, 30, 33, 34],
  ...
  'schiphol': {
    ...
    'airport': {
      'blacklist': [],
      'operatorWhitelist': [0, 1, 2, 3, 5, 6, 8, 9, 10, 11, 13, 14, 15, 18, 19, 20, 23, 25, 26, 27, 29, 33],
      'region': 'europe',
      'elevation': -11,
      'rwyusage': [
        {
...
export default Object.assign(maps, newYorkMaps, additionalUsAirports);
