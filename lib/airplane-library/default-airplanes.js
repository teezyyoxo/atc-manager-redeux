import { applyCurrentFleetAssignments } from './current-fleets';
...
const builtInAirplanes = applyCurrentFleetAssignments(
  legacyAirplanes
    .map(model => aircraft(model, refinements[model.id]))
